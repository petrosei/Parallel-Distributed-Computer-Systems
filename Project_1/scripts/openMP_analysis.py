...
plt.figure(1)
plt.xlabel('Array length (2^q)')
plt.ylabel('time')
plt.title('Imperative OpenMP method vs qsort')
plt.plot(Q, qtime , '-ro', linewidth=3.0,label = "qsort")
plt.legend(loc='upper left')
plt.figure(2)
plt.xlabel('Array length (2^q)')
plt.ylabel('time')
plt.title('Recursive OpenMP method vs qsort')
plt.plot(Q, qtime , '-ro', linewidth=3.0,label = "qsort")
plt.legend(loc='upper left')
plt.show()
